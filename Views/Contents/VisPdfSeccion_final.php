      ...
      <div class="flex space-x-1 my-1">
        <span class="w-8/12 flex flex-row">
          ...
          <div class="border-b border-black w-full mx-1">
            <!-- PROLONGACIÓN, CALLE 10, SECTOR LA MANGUERA -->
          </div>
        </span>
        <span class="w-4/12 flex flex-row">
          <span class="font-bold">
              ...
              <td class="">
                <table>
                  <tbody style="height: 100px !important;">
                    <tr class="">
                      <td class="text-center border border-black" >N</td>
                      <td class="text-center border-l border-r border-black" style="width: 70px !important;">Cedula de 
                        <br> 
                        Identidad</td>
                      <td class="w-3/12 text-center border-r border-black">Apellidos</td>
                      <td class="w-3/12 text-center border-r border-black">Nombres</td>
                      <td class="w-4/12 text-center">Lugar de Nacimiento</td>
                      <td class="w-1/12 h-full ">
                        <table class="w-full h-40 m-0">
                          <tbody class="h-full">
                            <tr>
                              <td class='border-l border-black' style="width: 1px !important;">E.F</td>
                              <td class='border-l border-black text-center' style="width: 18px !important;">S <br> E <br> X <br> O</td>
                              <td class="bg-red h-full border-l border-black">
                                <table class="w-full h-full bg-red-">
                                  <tbody class="bg-red-">
                                    <tr class="border-b border-black" style="height: 66px !important;">
                                      <td class="w-full text-center">Fecha de Nacimiento</td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td class="">
                                        <table class="" >
                                          <tbody>
                                            <tr>
                                              <td class="border-r border-b border-black text-center">9</td>
                                            </tr>
                                            <tr>
                                              <td class="border-r border-black text-center">PG</td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
                  ...
                  <tbody>
                    <?php 
                      for($i = 0; $i < 30; $i++){
                        ...
                        ?>
                      <tr class="w-full">
                        <th class="border border-black " style="width: 14px !important;"><?php echo ($i + 1);?></td>
                        <td class="border border-black " style="width: 68px !important;"><?php echo $cedula;?></td>
                        <td class="border border-black " style="width: 218px !important;"><?php echo $apellido;?></td>
                        <td class="border border-black " style="width: 218px !important;"><?php echo $nombre;?></td>
                        <td class="border border-black " style="width: 218px !important;"><?php echo $lugar_n;?></td>
                        <td class="border border-black" style="width: 19px !important;"><?php echo 'P';?></td>
                        <td class="border border-black text-center" style="width: 18px !important;"><?php echo $sexo;?></td>
    
                        <td class="border border-black" style="width: 20px !important;"><?php echo $dia;?></td>
                        <td class="border border-black" style="width: 18px !important;"><?php echo $mes;?></td>
                        <td class="border border-black" style="width: 18px !important;"><?php echo $anio;?></td>
                        ...
                        <?php 
                          for($x = 0; $x < 9; $x++){
                            ...
                            <!-- <td class="border border-black" style="width: 17px !important;"></td>
                            <td class="border border-black" style="width: 18px !important;"></td>
                            <td class="border border-black" style="width: 16px !important;"></td>
                            <td class="border border-black" style="width: 17px !important;"></td>
                            <td class="border border-black" style="width: 17px !important;"></td>
                            <td class="border border-black" style="width: 17px !important;"></td>
                            <td class="border border-black" style="width: 17px !important;"></td>
                            <td class="border border-black" style="width: 19px !important;"></td> -->
                            <?php
                        ...
                        <tbody class="w-full text-center">
                          <tr class="w-full">
                            ...
                            <td class="border border-black">
                              <table class="w-full">
                                <tbody>
                                  <tr><td class="border-b border-black">VI. Identiicación del Curso</td></tr>
                                  <tr><td>Plan de estudio</td></tr>
                                </tbody>
                              </table>
                            </td>
                          </tr>
