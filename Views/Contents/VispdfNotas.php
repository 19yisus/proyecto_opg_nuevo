			...
			<div id="content-form" class="content-form">
				...
				<div class="div-table">
					<div>
						...
						<div class="datosPlantel">
							Código: <input type="text" class="cedulaE" value="<?php echo $code_pensum_basica; ?>"> Nombre:<span class="nombreInstitución">UNIDAD EDUCATIVA NACIONAL ÓSCAR PICÓN GIACOPÍNI</span>
						</div>
						<div class="datosPlantel">
									...
									<tr>
										...
										?>
												<td>
													...
													<table class="datatable-container" autosize="1.0">
														<thead>
															<tr>
				...
				<div id="content-form" class="content-form">
					...
					<div class="div-table">
						<div>
							...
							<div class="datosPlantel">
								Código: <input type="text" class="cedulaE" value="<?php echo $code_pensum_diversificado; ?>"> Nombre:<span class="nombreInstitución">UNIDAD EDUCATIVA NACIONAL ÓSCAR PICÓN GIACOPÍNI</span>
							</div>
							<div class="datosPlantel">
								Dirección:<input type="text" class="ubicacion" value="PROLONGACIÓN CALLE 10 AGUA BLANCA"> Teléfono: <input type="text" class="telefono" value="0424-5883315">
							</div>
                                  ...
                                  <?php } ?>
										...
										<tr>
											<td>
												...
												?>
														<div class="segundoanio-title">SEXTO AÑO</div>
														<table class="datatable-container" style="margin: -5px; padding: 0; width: 100%;">
															<thead>
																<tr>
																	<th class="content-areaFormacion">ÁREAS DE <br> FORMACIÓN</th>
																	<th>
