...
<body>
  <div class="col-md-12">
    <div class="row" id="App_vue">
      ...
      <!-- Modal -->
      <div class="modal modal-lg fade" id="staticBackdrop" data-bs-keyboard="false"
              ...
              <div class="col-md-4" style="margin:0; padding: 5px;">
                ...
                <div class="d-flex">
                  <div class="form-check">
                    <input type="radio" name="sexo" :disabled="action == 'Asignacion'" v-model="sexo" value="F" id="radio" class="form-check-input" required>
                    <label for="">F</label>
                  </div>
                  <div class="form-check pl-2">
                    <input type="radio" name="sexo" :disabled="action == 'Asignacion'" v-model="sexo" value="M" id="radio1" class="form-check-input" required>
                    <label for="">M</label>
                  </div>
                </div>
              </div>
  ...
  <?php $this->Script(); ?>
   <script>
    const app = Vue.createApp({
      ...
      watch: {
        seguimiento(newAnio){ if(newAnio != '') this.consultarSecciones(newAnio); else this.secciones = []; },
