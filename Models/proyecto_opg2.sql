...
(1, 2, 1, '2022-12-05 03:37:10', 'no', 'Nuevo Registro'),
(2, 2, 2, '2022-12-05 03:37:10', 'no', 'Nuevo Registro'),
(3, 2, 3, '2022-12-05 03:37:11', 'no', 'Nuevo Registro'),
...
(2, 'periodo_escolar', 'REGISTRO', '1', '2022-12-05 03:18:52', 2),
(3, 'pensum', 'REGISTRO', '1', '2022-12-05 03:19:06', 2),
(4, 'seccion', 'REGISTRO', '1', '2022-12-05 03:19:42', 2),
(5, 'seccion', 'REGISTRO', '2', '2022-12-05 03:19:43', 2),
(6, 'seccion', 'REGISTRO', '3', '2022-12-05 03:19:43', 2),
(7, 'seccion', 'REGISTRO', '4', '2022-12-05 03:19:43', 2),
(8, 'seccion', 'REGISTRO', '5', '2022-12-05 03:19:43', 2),
(9, 'materia', 'REGISTRO', '1', '2022-12-05 03:20:01', 2),
(10, 'materia', 'REGISTRO', '2', '2022-12-05 03:20:15', 2),
(11, 'materia', 'REGISTRO', '3', '2022-12-05 03:20:27', 2),
(12, 'materia', 'REGISTRO', '4', '2022-12-05 03:20:42', 2),
(13, 'materia', 'REGISTRO', '5', '2022-12-05 03:20:59', 2),
(14, 'materia', 'REGISTRO', '6', '2022-12-05 03:21:21', 2),
(15, 'materia', 'REGISTRO', '7', '2022-12-05 03:21:33', 2),
(16, 'seccion', 'REGISTRO', '6', '2022-12-05 03:38:18', 2),
(17, 'seccion', 'REGISTRO', '7', '2022-12-05 03:38:18', 2),
(18, 'seccion', 'REGISTRO', '8', '2022-12-05 03:38:18', 2),
(19, 'seccion', 'REGISTRO', '9', '2022-12-05 03:38:18', 2),
(20, 'seccion', 'REGISTRO', '10', '2022-12-05 03:38:18', 2),
(21, 'seccion', 'REGISTRO', '11', '2022-12-05 03:38:19', 2),
(22, 'seccion', 'REGISTRO', '12', '2022-12-05 03:38:19', 2),
(23, 'materia', 'ACTUALIZACION', '3', '2022-12-05 03:38:32', 2),
(24, 'materia', 'ACTUALIZACION', '6', '2022-12-05 03:38:38', 2),
(25, 'materia', 'ACTUALIZACION', '4', '2022-12-05 03:38:44', 2),
(26, 'periodo_escolar', 'REGISTRO', '2', '2022-12-05 06:38:23', 2),
(27, 'periodo_escolar', 'CAMBIO DE ESTATUS (DESACTIVACION DE REGISTRO)', '1', '2022-12-05 06:38:27', 2),
(28, 'periodo_escolar', 'CAMBIO DE ESTATUS (ACTIVACION DE REGISTRO)', '2', '2022-12-05 06:38:29', 2),
(29, 'pensum', 'REGISTRO', '2', '2022-12-05 06:39:03', 2),
(30, 'seccion', 'REGISTRO', '13', '2022-12-05 06:39:39', 2),
(31, 'seccion', 'REGISTRO', '14', '2022-12-05 06:39:40', 2),
(32, 'seccion', 'REGISTRO', '15', '2022-12-05 06:39:45', 2),
(33, 'seccion', 'REGISTRO', '16', '2022-12-05 06:39:45', 2),
(34, 'seccion', 'REGISTRO', '17', '2022-12-05 06:39:51', 2),
(35, 'seccion', 'REGISTRO', '18', '2022-12-05 06:39:51', 2),
(36, 'materia', 'REGISTRO', '8', '2022-12-05 06:40:33', 2),
(37, 'materia', 'REGISTRO', '9', '2022-12-05 06:40:51', 2),
(38, 'materia', 'REGISTRO', '10', '2022-12-05 06:41:08', 2),
...
CREATE TABLE `director` (
  `cedula_director` char(8) COLLATE utf8_spanish_ci NOT NULL,
  `estatus_director` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `director` (`cedula_director`, `estatus_director`) VALUES
('00001112', 0),
('14585203', 1),
('9511515', 0);
...
CREATE TABLE `institucion` (
  ...
  `codigo_institucion` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
  `direccion_institucion` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
  `municipio` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `entidad_federal` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `zona_educativa` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `telefono` varchar(12) COLLATE utf8_spanish_ci DEFAULT NULL,
  `estatus_institucion` tinyint(1) NOT NULL DEFAULT 1,
  `si_externa` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, 'matematicas', 1, 1, 1, 1, 0, 0, 0, 0, 0),
(2, 'ingles', 1, 1, 1, 1, 0, 0, 0, 0, 0),
(3, 'castellano', 1, 1, 1, 1, 1, 0, 0, 0, 0),
(4, 'geografia', 1, 1, 1, 1, 1, 0, 0, 0, 0),
(5, 'historia de venezuela', 1, 1, 1, 1, 0, 0, 0, 0, 0),
(6, 'fisica', 1, 1, 1, 1, 1, 0, 0, 0, 0),
(7, 'quimica', 1, 1, 1, 1, 0, 0, 0, 0, 0),
(8, 'educacion fisica', 1, 2, 2, 1, 1, 1, 0, 0, 0),
(9, 'matematicas', 1, 2, 2, 1, 1, 1, 0, 0, 0),
(10, 'historia', 1, 2, 2, 1, 1, 1, 0, 0, 0);
...
CREATE TABLE `nota` (
  ...
  `plantel` varchar(5) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `nota` (`idNota`, `cedula_estudiante`, `periodo_escolar_id`, `seccion_id`, `materia_id`, `lapso_id`, `nota_lapso1`, `nota_lapso2`, `nota_lapso3`, `nota_final`, `recuperativo_1`, `recuperativo_2`, `recuperativo_3`, `recuperativo_4`, `estatusNotas`, `plantel`) VALUES
(1, '10425562', 1, 1, 1, NULL, NULL, NULL, NULL, 10, 1, 1, 1, 1, 0, ''),
(2, '10425562', 1, 1, 2, NULL, NULL, NULL, NULL, 10, 1, 1, 1, 1, 0, ''),
(3, '10425562', 1, 1, 3, NULL, NULL, NULL, NULL, 15, 1, 1, 1, 1, 0, ''),
...
--
-- Estructura de tabla para la tabla `notas_externas`
--

CREATE TABLE `notas_externas` (
  `nota_externa` int(11) NOT NULL,
  `id_estudiante_ext` char(8) COLLATE utf8_spanish_ci NOT NULL,
  `des_materia_ext` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `nota_ext` int(2) NOT NULL,
  `periodo_ext` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
...
(85, 'GM', 'Gambia'),
(86, 'GE', 'Georgia'),
(87, 'GS', 'Islas Georgias del Sur y Sandwich del Sur'),
(88, 'GH', 'Ghana'),
(89, 'GI', 'Gibraltar'),
(90, 'GD', 'Granada'),
(91, 'GR', 'Grecia'),
...
(94, 'GU', 'Guam'),
(95, 'GT', 'Guatemala'),
(96, 'GF', 'Guayana Francesa'),
(97, 'GN', 'Guinea'),
(98, 'GQ', 'Guinea Ecuatorial'),
(99, 'GW', 'Guinea-Bissau'),
(100, 'GY', 'Guyana'),
(101, 'HT', 'Haití'),
(102, 'HM', 'Islas Heard y McDonald'),
(103, 'HN', 'Honduras'),
(104, 'HK', 'Hong Kong'),
(105, 'HU', 'Hungría'),
(106, 'IN', 'India'),
...
(137, 'ML', 'Malí'),
(138, 'MT', 'Malta'),
(139, 'FK', 'Islas Malvinas'),
(140, 'MP', 'Islas Marianas del Norte'),
(141, 'MA', 'Marruecos'),
(142, 'MH', 'Islas Marshall'),
(143, 'MQ', 'Martinica'),
(144, 'MU', 'Mauricio'),
(145, 'MR', 'Mauritania'),
(146, 'YT', 'Mayotte'),
...
(2, '1988-1989', '1988-09-01', '1989-07-28', 1, 1),
(3, '1990-1991', '1990-09-08', '1991-07-28', 0, 1);
...
CREATE TABLE `personas` (
  ...
  `fecha_n_persona` date DEFAULT NULL,
  `direccion_persona` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `entidad_federal` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `municipio` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `personas` (`cedula_persona`, `nombre_persona`, `apellido_persona`, `nacionalidad_persona`, `sexo_persona`, `correo_persona`, `fecha_n_persona`, `direccion_persona`, `telefono_persona`, `direccion_n_persona`, `pais`, `entidad_federal`, `municipio`) VALUES
('00001112', 'Juan de Jesus', 'Batista', 'V', 'M', NULL, NULL, 'nohay', '00001112', NULL, NULL, NULL, NULL),
('10412103', 'jose antonio', 'antequera', 'V', 'M', NULL, '1969-09-02', 'fasdfasdfasdf', '10412103', NULL, 'venezuela', 'lara', 'barquisimeto'),
('10425562', 'jose', 'villa lobos', 'V', 'M', NULL, '1976-05-01', 'fasdfasdfasdf', '10425562', NULL, 'venezuela', 'portuguesa', 'agua blanca'),
...
ALTER TABLE `director`
  ADD PRIMARY KEY (`cedula_director`);
...
--
-- Indices de la tabla `notas_externas`
--
ALTER TABLE `notas_externas`
  ADD PRIMARY KEY (`nota_externa`),
  ADD KEY `id_estudiante_ext` (`id_estudiante_ext`);
...
--
ALTER TABLE `periodo_escolar`
  MODIFY `id_periodo_escolar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `director`
  ADD CONSTRAINT `director_ibfk_1` FOREIGN KEY (`cedula_director`) REFERENCES `personas` (`cedula_persona`);
...
--
-- Filtros para la tabla `notas_externas`
--
ALTER TABLE `notas_externas`
  ADD CONSTRAINT `notas_externas_ibfk_1` FOREIGN KEY (`id_estudiante_ext`) REFERENCES `estudiante` (`cedula_estudiante`) ON UPDATE CASCADE;
