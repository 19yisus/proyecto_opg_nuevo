<?php	
	...
	class App{
		...
		private $vistasPrivadas = ['VisEstudiantes','VisUsuarios','VisAsignacionProfesor','VisAsignacionEstudiantes','VisPrincipal','VisInicio','VisMaterias','VisNotas','VisPensum','VisPeriodo','VisProfesor','VisSeccion','VispdfNotas','VisCreatePdfNotas','VisCreatePdfEstudiantes','VisInstitucion'];
